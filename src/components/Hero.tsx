...
const Hero = () => {
  return (
    <section id="home" className="min-h-screen magical-bg pt-24 relative overflow-hidden">
      {/* Decorative sparkles */}
      ...
      <div className="container mx-auto px-4 py-16 md:py-24 flex flex-col items-center justify-center">
        <div className="flex items-center justify-center mb-6">
          <Sparkles className="text-magic-primary mr-2 animate-sparkle" size={24} />
          <span className="text-white/80 uppercase tracking-widest text-sm">Shows de Mágica Profissional</span>
          <Sparkles className="text-magic-primary ml-2 animate-sparkle" size={24} />
        </div>
        ...
        <h1 className="text-4xl md:text-5xl lg:text-7xl font-bold text-center mb-6 leading-tight">
          ...
          <br /> para Eventos <span className="magical-text">Inesquecíveis</span>
        </h1>
        
        <p className="text-white/80 text-center max-w-2xl mb-10 text-lg">
          Transforme seu evento em uma experiência extraordinária com apresentações 
          de mágica envolventes que irão surpreender e encantar todos os seus convidados.
        </p>
